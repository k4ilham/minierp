...
<table border="1" width="100%" cellspacing="4" cellpadding="4" style="border-collapse: collapse;">
	<tr>
		<td align="center" width="25%">
			<img src="<?php echo Url::base(); ?>/file/newlogo.png" width="50px" height="auto">
			<br>PT. INTAN JAYA MEDIKA SOLUSI
		</td>
		<td width="75%" align="center" colspan="2" style="font-size:20px;font-weight: bold;">REPORT KARYAWAN</td>
	</tr>
	<tr>
