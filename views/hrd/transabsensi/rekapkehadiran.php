...
$this->title = 'Monitoring Kehadiran Periode : '.Yii::$app->helperdb->periodeAktif();
...
<div class="box box-primary box-solid">
    ...
    <div class="box-body">
        ...
        foreach($model as $row){ 
            ...
            <tr>
                <td align="center">
                    <?=Html::a("...", ['rekapkehadirandetail', 'id' => $row->id_karyawan], ['class' => 'btn btn-primary btn-xs','data-toggle'=>"modal",
                                'data-target'=>"#myModal",])?>
                </td>
