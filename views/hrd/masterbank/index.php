...
<div class="box box-primary box-solid">
    ...
    <div class="box-body">
        ...
        foreach($model as $row){ ?>
            <tr>
                <td align="center">
                    <?=Html::a("...", ['view', 'id' => $row->id_bank], ['class' => 'btn btn-primary btn-xs','data-toggle'=>"modal",
                                'data-target'=>"#myModal",])?>
                </td>
                <td align="center"><?=$no?></td>
                <td align="left"><?=$row->nama_bank?></td>
                <td align="left"><?=$row->kode_bank?></td>
            </tr>
        <?php $no++; } ?>
        </tbody>
        </table>
