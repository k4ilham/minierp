...
<div class="box box-primary box-solid">
    ...
    <div class="box-body">
        ...
        foreach($model as $row){ ?>
            <tr>
                <td align="center">
                    <?=Html::a("...", ['view', 'id' => $row->id_vendor], ['class' => 'btn btn-primary btn-xs','data-toggle'=>"modal",
                                'data-target'=>"#myModal",])?>
                </td>
                <td align="center"><?=$no?></td>
                <td align="left"><?=$row->kode_vendor?></td>
                <td align="left"><?=$row->nama_vendor?></td>
            </tr>
        <?php $no++; } ?>
        </tbody>
        </table>
