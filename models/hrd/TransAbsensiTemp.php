...
/**
 * This is the model class for table "trans_absensi_temp".
 *
 ...
 */
class TransAbsensiTemp extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * {@inheritdoc}
     * @return TransAbsensiTempQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new TransAbsensiTempQuery(get_called_class());
    }
}
