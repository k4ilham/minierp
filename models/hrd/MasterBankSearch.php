...
/**
 * MasterBankSearch represents the model behind the search form of `app\models\hrd\MasterBank`.
 */
class MasterBankSearch extends MasterBank
{
    ...
    public function rules()
    {
        return [
            ...
            [['nama_bank', 'kode_bank', 'created_at', 'updated_at'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'nama_bank', $this->nama_bank])
            ->andFilterWhere(['like', 'kode_bank', $this->kode_bank]);
