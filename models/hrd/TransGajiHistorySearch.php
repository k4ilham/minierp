...
/**
 * TransGajiHistorySearch represents the model behind the search form of `app\models\hrd\TransGajiHistory`.
 */
class TransGajiHistorySearch extends TransGajiHistory
{
    /**
     * {@inheritdoc}
     */
